...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       # as classifier label
       model_label = classifier(images_dir[key]+results_dic[key],model)
       ...
       if truth in model_label:
           results_dic[images_dir[key]].extend([model_label,1])
       ...
       # the extend function 
           ...
           results_dic[images_dir[key]].extend([model_label,0])
